...
def planter(r=80, h=50, wall_thick=4, main_color="#dddd55", demo=False):
    ...
    pts = [
        ...
        [
            r - wall_thick,
            tray_wall_thick + tray_w + vert_gap + tray_ht + tray_wall_ht
        ],
        [
            r - tray_wall_thick - tray_w - wall_thick,
            tray_ht + tray_wall_ht + vert_gap
        ],  # slant inwards to mirror inset for moat
        [0, center_ht],
    ]
    ...
    m = rotate_extrude(angle=angle)(profile())
    ...
    for i, ang in enumerate(range(0, 360, dtheta)):
        ...
        dr = translate(pt)(rotate([0, tilt,
                                   0])(translate([0, 0, -wall_thick])(cylinder(
                                       r=hole_r, h=wall_thick * 2))))
